...
プレイヤーは最初、デフォルト速度で走っている。加速キーを押している間は加速時速度、減速キーを押している間は減速時速度で走る。

走っているとギミックが流れてくる。BoostWall と BreakWall のいずれかがランダムで生成される。

- 加速オブジェ: 加速中のみダメージを受けない
- 減速オブジェ: 減速中のみダメージを受けない
